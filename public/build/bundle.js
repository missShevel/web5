...
var app = (function () {
  ...
  function dispatch_dev(type, detail) {
    document.dispatchEvent(
      custom_event(type, Object.assign({ version: '3.44.3' }, detail), true),
    );
  }
...
`;
  ...
  var f,
    ...
    V = function (e, t) {
      return arguments.length < 2 ? Z(p[e]) : p[e] && p[e][t];
    },
    N = E({}.isPrototypeOf),
    X = V('navigator', 'userAgent') || '',
    D = p.process,
    z = p.Deno,
    Y = (D && D.versions) || (z && z.version),
    J = Y && Y.v8;
  J && (d = (f = J.split('.'))[0] > 0 && f[0] < 4 ? 1 : +(f[0] + f[1])),
    !d &&
      X &&
      (!(f = X.match(/Edge\/(\d+)/)) || f[1] >= 74) &&
      (f = X.match(/Chrome\/(\d+)/)) &&
      (d = +f[1]);
  var B = d,
    G =
    ...
    M = G && !Symbol.sham && 'symbol' == typeof Symbol.iterator,
    H = p.Object,
    q = M
      ? function (e) {
    ...
    te = function (e) {
      if (L(e)) return e;
      throw ee($(e) + ' is not a function');
    },
    ne = function (e, t) {
      var n = e[t];
      return null == n ? void 0 : te(n);
    },
    re = p.TypeError,
    oe = Object.defineProperty,
    ie = function (e, t) {
      try {
        oe(p, e, { value: t, configurable: !0, writable: !0 });
      } catch (n) {
        p[e] = t;
      }
      return t;
    },
    ae = p['__core-js_shared__'] || ie('__core-js_shared__', {}),
    ce = l(function (e) {
    ...
    pe = E((1).toString),
    ye = function (e) {
      return 'Symbol(' + (void 0 === e ? '' : e) + ')_' + pe(++de + he, 36);
    },
    ve = ce('wks'),
    me = p.Symbol,
    ge = me && me.for,
    be = M ? me : (me && me.withoutSetter) || ye,
    we = function (e) {
      if (!fe(ve, e) || (!G && 'string' != typeof ve[e])) {
        var t = 'Symbol.' + e;
        G && fe(me, e) ? (ve[e] = me[e]) : (ve[e] = M && ge ? ge(t) : be(t));
      }
      return ve[e];
    },
    Se = p.TypeError,
    ...
    ke = function (e, t) {
      ...
      var n,
        r = ne(e, _e);
      if (r) {
        if ((void 0 === t && (t = 'default'), (n = g(r, e, t)), !W(n) || q(n)))
          return n;
      ...
      return (
        ...
        (function (e, t) {
          var n, r;
          if ('string' === t && L((n = e.toString)) && !W((r = g(n, e))))
            return r;
          if (L((n = e.valueOf)) && !W((r = g(n, e)))) return r;
          if ('string' !== t && L((n = e.toString)) && !W((r = g(n, e))))
            return r;
    ...
    Te = p.document,
    Oe = W(Te) && W(Te.createElement),
    Ee = function (e) {
      return Oe ? Te.createElement(e) : {};
    },
    xe =
      !v &&
      !y(function () {
    ...
    Re = {
      f: v
        ...
        : function (e, t) {
            ...
            if (fe(e, t)) return _(!g(S.f, e, t), e[t]);
          },
    },
    Fe = p.String,
    Ae = p.TypeError,
    je = function (e) {
      if (W(e)) return e;
      throw Ae(Fe(e) + ' is not an object');
    },
    Ue = p.TypeError,
    ...
    Le = v
      ? function (e, t, n) {
          return Pe.f(e, t, _(1, n));
        }
      : function (e, t, n) {
          return (e[t] = n), e;
        },
    We = E(Function.toString);
  L(ae.inspectSource) ||
  ...
  var Ze,
    ...
    Xe = ae.inspectSource,
    De = p.WeakMap,
    ze = L(De) && /native code/.test(Xe(De)),
    Ye = ce('keys'),
    Je = function (e) {
    ...
    Me = p.WeakMap;
  if (ze || ae.state) {
    var He = ae.state || (ae.state = new Me()),
      qe = E(He.get),
      Qe = E(He.has),
      $e = E(He.set);
    (Ze = function (e, t) {
      if (Qe(He, e)) throw new Ge('Object already initialized');
      return (t.facade = e), $e(He, e, t), t;
    }),
      (Ve = function (e) {
        return qe(He, e) || {};
      }),
    ...
    (Be[et] = !0),
      (Ze = function (e, t) {
        if (fe(e, et)) throw new Ge('Object already initialized');
        return (t.facade = e), Le(e, et, t), t;
      }),
      (Ve = function (e) {
        return fe(e, et) ? e[et] : {};
      }),
  ...
  var tt = {
      ...
      has: Ne,
      enforce: function (e) {
        return Ne(e) ? Ve(e) : Ze(e, {});
      },
      getterFor: function (e) {
        return function (t) {
          var n;
          if (!W(t) || (n = Ve(t)).type !== e)
            throw Ge('Incompatible receiver, ' + e + ' required');
          return n;
        };
      },
    },
    nt = Function.prototype,
    rt = v && Object.getOwnPropertyDescriptor,
    ot = fe(nt, 'name'),
    it = {
      EXISTS: ot,
      PROPER: ot && 'something' === function () {}.name,
      CONFIGURABLE: ot && (!v || (v && rt(nt, 'name').configurable)),
    },
    at = l(function (e) {
      var t = it.CONFIGURABLE,
        n = tt.get,
        r = tt.enforce,
      ...
      (e.exports = function (e, n, i, a) {
        ...
        L(i) &&
          ...
          (!fe(i, 'name') || (t && i.name !== f)) && Le(i, 'name', f),
          (c = r(i)).source ||
        ...
        return (L(this) && n(this).source) || Xe(this);
      });
    }),
    ct = Math.ceil,
    st = Math.floor,
    ut = function (e) {
      var t = +e;
      return t != t || 0 === t ? 0 : (t > 0 ? st : ct)(t);
    },
    lt = Math.max,
    ft = Math.min,
    dt = Math.min,
    ht = function (e) {
      return e > 0 ? dt(ut(e), 9007199254740991) : 0;
    },
    pt = function (e) {
      return ht(e.length);
    },
    ...
    bt = function (e, t) {
      var n,
        ...
        o = 0,
        i = [];
      for (n in r) !fe(Be, n) && fe(r, n) && gt(i, n);
      for (; t.length > o; ) fe(r, (n = t[o++])) && (~mt(i, n) || gt(i, n));
      return i;
    },
    wt = [
      'constructor',
    ...
    Ot = function (e, t) {
      for (var n = Tt(t), r = Pe.f, o = Re.f, i = 0; i < n.length; i++) {
        var a = n[i];
        fe(e, a) || r(e, a, o(t, a));
      }
    },
    ...
    xt = function (e, t) {
      var n = Rt[Ct(e)];
      return n == At || (n != Ft && (L(t) ? y(t) : !!t));
    },
    Ct = (xt.normalize = function (e) {
    ...
    Kt = function (e, t) {
      var n,
        ...
        s = e.global,
        u = e.stat;
      if ((n = s ? p : u ? p[c] || ie(c, {}) : (p[c] || {}).prototype))
        for (r in t) {
          if (
            ((i = t[r]),
            (o = e.noTargetGet ? (a = Ut(n, r)) && a.value : n[r]),
            !jt(s ? r : c + (u ? '.' : '#') + r, e.forced) && void 0 !== o)
          ) {
            if (typeof i == typeof o) continue;
            Ot(i, o);
          }
          (e.sham || (o && o.sham)) && Le(i, 'sham', !0), at(n, r, i, e);
        }
    },
    Pt = {};
  Pt[we('toStringTag')] = 'z';
  var Lt,
    Wt = '[object z]' === String(Pt),
    Zt = we('toStringTag'),
    Vt = p.Object,
    Nt =
      'Arguments' ==
    ...
    Bt = function (e) {
      if (
        (function (e) {
          var t;
          return W(e) && (void 0 !== (t = e[Yt]) ? !!t : 'RegExp' == R(e));
        })(e)
      )
        throw Jt("The method doesn't accept regular expressions");
      return e;
    },
    Gt = we('match'),
    Mt = function (e) {
    ...
    en = Mt('startsWith'),
    tn = !(
      en || ((Lt = Ht(String.prototype, 'startsWith')), !Lt || Lt.writable)
    );
  Kt(
    { target: 'String', proto: !0, forced: !tn && !en },
    {
      startsWith: function (e) {
        var t = zt(K(this));
        Bt(e);
        var n = ht($t(arguments.length > 1 ? arguments[1] : void 0, t.length)),
          r = zt(e);
        return qt ? qt(t, r, n) : Qt(t, n, n + r.length) === r;
      },
    },
  );
  var nn = function (e, t) {
    return E(p[e].prototype[t]);
  };
  nn('String', 'startsWith');
  var rn,
    on =
      Array.isArray ||
      function (e) {
    ...
    an = function (e, t, n) {
      var r = Ie(t);
      r in e ? Pe.f(e, r, _(0, n)) : (e[r] = n);
    },
    cn = function () {},
    sn = [],
    un = V('Reflect', 'construct'),
  ...
  Kt(
    { target: 'Array', proto: !0, forced: !Sn || !_n },
    {
      concat: function (e) {
        var t,
          n,
        ...
        for (t = -1, r = arguments.length; t < r; t++)
          if (kn((i = -1 === t ? a : arguments[t]))) {
            if (s + (o = pt(i)) > 9007199254740991)
              throw wn('Maximum allowed index exceeded');
            for (n = 0; n < o; n++, s++) n in i && an(c, s, i[n]);
          } else {
  ...
  Wt || at(Object.prototype, 'toString', In, { unsafe: !0 });
  var Tn,
    ...
    An = v
      ...
      : function (e, t) {
          je(e);
          for (var n, r = P(t), o = Fn(t), i = o.length, a = 0; i > a; )
            Pe.f(e, (n = o[a++]), r[n]);
          return e;
        },
    jn = V('document', 'documentElement'),
    Un = Je('IE_PROTO'),
    Kn = function () {},
    Pn = function (e) {
    ...
    Wn = function () {
      ...
      Wn =
        'undefined' != typeof document
          ? document.domain && Tn
            ? Ln(Tn)
            : (((t = Ee('iframe')).style.display = 'none'),
              jn.appendChild(t),
              (t.src = String('javascript:')),
              (e = t.contentWindow.document).open(),
              e.write(Pn('document.F=Object')),
              e.close(),
              e.F)
          : Ln(Tn);
      for (var n = wt.length; n--; ) delete Wn.prototype[wt[n]];
      return Wn();
    };
  Be[Un] = !0;
  var Zn =
    ...
    Bn = function (e) {
      ...
      fe(t, e) || Jn(t, e, { value: zn.f(e) });
    },
    Gn = Pe.f,
    Mn = we('toStringTag'),
    Hn = function (e, t, n) {
      e &&
        !fe((e = n ? e : e.prototype), Mn) &&
        Gn(e, Mn, { configurable: !0, value: t });
    },
    qn = E(E.bind),
    Qn = function (e, t) {
      return (
    ...
    mr = ce('symbols'),
    gr = ce('op-symbols'),
    br = ce('string-to-symbol-registry'),
    wr = ce('symbol-to-string-registry'),
    Sr = ce('wks'),
    _r = !lr || !lr.prototype || !lr.prototype.findChild,
    kr =
      v &&
      y(function () {
        return (
        ...
        ? function (e, t, n) {
            var r = dr(ar, t);
            r && delete ar[t], hr(e, t, n), r && e !== ar && hr(ar, t, r);
          }
        : hr,
    Ir = function (e, t) {
      var n = (mr[e] = Zn(sr));
      return (
        or(n, { type: 'Symbol', tag: e, description: t }),
        v || (n.description = t),
        n
      );
    },
    Tr = function (e, t, n) {
      ...
      return (
        ...
        fe(mr, r)
          ? (n.enumerable
              ? (fe(e, nr) && e[nr][r] && (e[nr][r] = !1),
                (n = Zn(n, { enumerable: _(0, !1) })))
              : (fe(e, nr) || hr(e, nr, _(1, {})), (e[nr][r] = !0)),
            kr(e, r, n))
          : hr(e, r, n)
      );
    },
    ...
    Er = function (e) {
      var t = Ie(e),
        n = g(yr, this, t);
      return (
        !(this === ar && fe(mr, t) && !fe(gr, t)) &&
        (!(n || !fe(this, t) || !fe(mr, t) || (fe(this, nr) && this[nr][t])) ||
          n)
      );
    },
    xr = function (e, t) {
      var n = P(e),
        r = Ie(t);
      if (n !== ar || !fe(mr, r) || fe(gr, r)) {
        var o = dr(n, r);
        return (
          !o || !fe(mr, r) || (fe(n, nr) && n[nr][r]) || (o.enumerable = !0), o
        );
      }
    },
    Cr = function (e) {
  ...
  if (
    (G ||
      ((sr = (cr = function () {
        if (N(sr, this)) throw ur('Symbol is not a constructor');
        var e =
          ...
          n = function (e) {
            this === ar && g(n, gr, e),
              fe(this, nr) && fe(this[nr], t) && (this[nr][t] = !1),
              kr(this, t, _(1, e));
          };
        return v && _r && kr(ar, t, { configurable: !0, set: n }), Ir(t, e);
      }).prototype),
      at(sr, 'toString', function () {
        return ir(this).tag;
      }),
      at(cr, 'withoutSetter', function (e) {
        return Ir(ye(e), e);
      }),
      (S.f = Er),
      (Pe.f = Tr),
      ...
      v &&
        ...
        at(ar, 'propertyIsEnumerable', Er, { unsafe: !0 }))),
    Kt({ global: !0, wrap: !0, forced: !G, sham: !G }, { Symbol: cr }),
    tr(Fn(Sr), function (e) {
      Bn(e);
    }),
    Kt(
      { target: 'Symbol', stat: !0, forced: !G },
      {
        for: function (e) {
          var t = zt(e);
          if (fe(br, t)) return br[t];
          var n = cr(t);
          return (br[t] = n), (wr[n] = t), n;
        },
        keyFor: function (e) {
          if (!q(e)) throw ur(e + ' is not a symbol');
          if (fe(wr, e)) return wr[e];
        },
        useSetter: function () {
          _r = !0;
        },
    ...
    Kt(
      { target: 'Object', stat: !0, forced: !G, sham: !v },
      {
        create: function (e, t) {
          return void 0 === t ? Zn(e) : Or(Zn(e), t);
        },
        defineProperty: Tr,
        defineProperties: Or,
    ...
    Kt(
      ...
      { getOwnPropertyNames: Cr, getOwnPropertySymbols: Rr },
    ),
    Kt(
      {
        target: 'Object',
        ...
        stringify: function (e, t, n) {
          ...
          if ((W(t) || void 0 !== e) && !q(e))
            return (
              on(t) ||
                (t = function (e, t) {
                  if ((L(o) && (t = g(o, this, e, t)), !q(t))) return t;
                }),
              (r[1] = t),
              Rn(fr, null, r)
            );
  ...
  Hn(cr, 'Symbol'), (Be[nr] = !0), Bn('asyncIterator');
  var jr = Pe.f,
    Ur = p.Symbol,
    Kr = Ur && Ur.prototype;
  if (v && L(Ur) && (!('description' in Kr) || void 0 !== Ur().description)) {
    var Pr = {},
      Lr = function () {
        var e =
            arguments.length < 1 || void 0 === arguments[0]
              ? void 0
              : zt(arguments[0]),
          t = N(Kr, this) ? new Ur(e) : void 0 === e ? Ur() : Ur(e);
        return '' === e && (Pr[t] = !0), t;
      };
    Ot(Lr, Ur), (Lr.prototype = Kr), (Kr.constructor = Lr);
    var Wr = 'Symbol(test)' == String(Ur('test')),
      Zr = E(Kr.toString),
      Vr = E(Kr.valueOf),
      Nr = /^Symbol\((.*)\)[^)]+$/,
      Xr = E(''.replace),
    ...
    jr(Kr, 'description', {
      ...
      get: function () {
        var e = Vr(this),
          t = Zr(e);
        if (fe(Pr, e)) return '';
        var n = Wr ? Dr(t, 7, -1) : Xr(t, Nr, '$1');
        return '' === n ? void 0 : n;
      },
    }),
      Kt({ global: !0, forced: !0 }, { Symbol: Lr });
  }
  Bn('hasInstance'),
    Bn('isConcatSpreadable'),
    Bn('iterator'),
    Bn('match'),
    Bn('matchAll'),
    Bn('replace'),
  ...
  [].keys &&
    ('next' in (Jr = [].keys())
      ? (Yr = no(no(Jr))) !== Object.prototype && (zr = Yr)
      : (oo = !0)),
    (null == zr ||
      y(function () {
        var e = {};
        return zr[ro].call(e) !== e;
      })) &&
      (zr = {}),
    L(zr[ro]) ||
      at(zr, ro, function () {
  ...
  var io = { IteratorPrototype: zr, BUGGY_SAFARI_ITERATORS: oo },
    ao = {},
    co = io.IteratorPrototype,
    so = function () {
      return this;
    },
    uo = p.String,
            ...
            return function (n, r) {
              return (
                ...
                (function (e) {
                  ...
                  throw lo("Can't set " + uo(e) + ' as a prototype');
                })(r),
    ...
    ho = it.PROPER,
    po = it.CONFIGURABLE,
    yo = io.IteratorPrototype,
    vo = io.BUGGY_SAFARI_ITERATORS,
    mo = we('iterator'),
    go = function () {
      return this;
    },
    bo = function (e, t, n, r, o, i, a) {
      !(function (e, t, n) {
        var r = t + ' Iterator';
        (e.prototype = Zn(co, { next: _(1, n) })), Hn(e, r, !1), (ao[r] = so);
      })(n, t, r);
      var c,
        s,
        u,
        ...
        d = !1,
        h = e.prototype,
        p = h[mo] || h['@@iterator'] || (o && h[o]),
        y = (!vo && p) || l(o),
        v = ('Array' == t && h.entries) || p;
      if (
        (v &&
          (c = no(v.call(new e()))) !== Object.prototype &&
          c.next &&
          (no(c) !== yo && (fo ? fo(c, yo) : L(c[mo]) || at(c, mo, go)),
          Hn(c, f, !0)),
        ho &&
          'values' == o &&
          p &&
        ...
        if (
          ...
          for (u in s) (vo || d || !(u in h)) && at(h, u, s[u]);
        else Kt({ target: t, proto: !0, forced: vo || d }, s);
      return h[mo] !== y && at(h, mo, y, { name: o }), (ao[t] = y), s;
    },
    wo = qr.charAt,
    So = tt.set,
    _o = tt.getterFor('String Iterator');
  bo(
    String,
    'String',
    function (e) {
      So(this, { type: 'String Iterator', string: zt(e), index: 0 });
    },
    function () {
      var e,
        t = _o(this),
      ...
      return r >= n.length
        ? { value: void 0, done: !0 }
        : ((e = wo(n, r)), (t.index += e.length), { value: e, done: !1 });
    },
  );
  var ko = function (e, t, n) {
    ...
    Oo = Array.prototype,
    Eo = function (e) {
      return void 0 !== e && (ao.Array === e || Oo[To] === e);
    },
    xo = we('iterator'),
    Co = function (e) {
      if (null != e) return ne(e, xo) || ne(e, '@@iterator') || ao[Xt(e)];
    },
    Ro = p.TypeError,
    Fo = function (e, t) {
      var n = arguments.length < 2 ? Co(e) : t;
      if (te(n)) return je(g(n, e));
      throw Ro($(e) + ' is not iterable');
    },
    Ao = p.Array,
    jo = we('iterator'),
    Uo = !1;
    ...
    { target: 'Array', stat: !0, forced: Wo },
    {
      from: function (e) {
        var t = ue(e),
          ...
          i = void 0 !== o;
        i && (o = Qn(o, r > 2 ? arguments[2] : void 0));
        var a,
          c,
          s,
          u,
          ...
          h = 0;
        if (!d || (this == Ao && Eo(d)))
          for (a = pt(t), c = n ? new this(a) : Ao(a); a > h; h++)
            (f = i ? o(t[h], h) : t[h]), an(c, h, f);
        else
          for (
            l = (u = Fo(t, d)).next, c = n ? new this() : [];
            !(s = g(l, u)).done;
            h++
          )
            (f = i ? Io(u, o, [s.value, h], !0) : s.value), an(c, h, f);
        return (c.length = h), c;
      },
    },
  ),
  ...
  var Zo,
    Vo,
    No,
    Xo = 'undefined' != typeof ArrayBuffer && 'undefined' != typeof DataView,
    Do = Pe.f,
    zo = p.Int8Array,
    Yo = zo && zo.prototype,
    Jo = p.Uint8ClampedArray,
    Bo = Jo && Jo.prototype,
    Go = zo && no(zo),
    Mo = Yo && no(Yo),
    Ho = Object.prototype,
    qo = p.TypeError,
    Qo = we('toStringTag'),
    $o = ye('TYPED_ARRAY_TAG'),
    ei = ye('TYPED_ARRAY_CONSTRUCTOR'),
    ti = Xo && !!fo && 'Opera' !== Xt(p.opera),
    ni = !1,
    ri = {
      Int8Array: 1,
      Uint8Array: 1,
    ...
    oi = { BigInt64Array: 8, BigUint64Array: 8 },
    ii = function (e) {
      if (!W(e)) return !1;
      var t = Xt(e);
      return fe(ri, t) || fe(oi, t);
    };
  for (Zo in ri)
    (No = (Vo = p[Zo]) && Vo.prototype) ? Le(No, ei, Vo) : (ti = !1);
  for (Zo in oi) (No = (Vo = p[Zo]) && Vo.prototype) && Le(No, ei, Vo);
  if (
    (!ti || !L(Go) || Go === Function.prototype) &&
    ((Go = function () {
      throw qo('Incorrect invocation');
    }),
    ti)
  )
    for (Zo in ri) p[Zo] && fo(p[Zo], Go);
  if ((!ti || !Mo || Mo === Ho) && ((Mo = Go.prototype), ti))
    for (Zo in ri) p[Zo] && fo(p[Zo].prototype, Mo);
  if ((ti && no(Bo) !== Mo && fo(Bo, Mo), v && !fe(Mo, Qo)))
    for (Zo in ((ni = !0),
    Do(Mo, Qo, {
      get: function () {
        return W(this) ? this[$o] : void 0;
      },
    }),
    ri))
      p[Zo] && Le(p[Zo], $o, Zo);
  var ai = {
      ...
      TYPED_ARRAY_TAG: ni && $o,
      aTypedArray: function (e) {
        if (ii(e)) return e;
        throw qo('Target is not a typed array');
      },
      aTypedArrayConstructor: function (e) {
        if (L(e) && (!fo || N(Go, e))) return e;
        throw qo($(e) + ' is not a typed array constructor');
      },
      exportTypedArrayMethod: function (e, t, n) {
        if (v) {
          if (n)
            for (var r in ri) {
              var o = p[r];
              if (o && fe(o.prototype, e))
                try {
                  delete o.prototype[e];
                } catch (e) {}
            }
          (Mo[e] && !n) || at(Mo, e, n ? t : (ti && Yo[e]) || t);
        }
      },
      exportTypedArrayStaticMethod: function (e, t, n) {
        ...
        if (v) {
          if (fo) {
            ...
            if (Go[e] && !n) return;
            try {
              return at(Go, e, n ? t : (ti && Go[e]) || t);
            } catch (e) {}
          }
          for (r in ri) !(o = p[r]) || (o[e] && !n) || at(o, e, t);
        }
      },
      isView: function (e) {
        if (!W(e)) return !1;
        var t = Xt(e);
        return 'DataView' === t || fe(ri, t) || fe(oi, t);
      },
      isTypedArray: ii,
      TypedArray: Go,
      TypedArrayPrototype: Mo,
    },
    ci = p.TypeError,
    si = we('species'),
    ui = function (e, t) {
      var n,
        r = je(e).constructor;
      return void 0 === r || null == (n = je(r)[si])
        ? t
        : (function (e) {
            if (pn(e)) return e;
            throw ci($(e) + ' is not a constructor');
          })(n);
    },
    li = ai.TYPED_ARRAY_CONSTRUCTOR,
    fi = ai.aTypedArrayConstructor,
    di = ai.aTypedArray;
  (0, ai.exportTypedArrayMethod)(
    'slice',
    function (e, t) {
      for (
        var n,
  ...
  var hi = we('unscopables'),
    pi = Array.prototype;
  null == pi[hi] && Pe.f(pi, hi, { configurable: !0, value: Zn(null) });
  var yi = function (e) {
      pi[hi][e] = !0;
    },
    vi = vt.includes;
  Kt(
    ...
    {
      includes: function (e) {
        return vi(this, e, arguments.length > 1 ? arguments[1] : void 0);
      },
    },
  ),
    yi('includes'),
  ...
  var mi = E(''.indexOf);
  Kt(
    { target: 'String', proto: !0, forced: !Mt('includes') },
    {
      includes: function (e) {
        return !!~mi(
          zt(K(this)),
    ...
    nn('String', 'includes');
  var gi = tt.set,
    bi = tt.getterFor('Array Iterator');
  bo(
    Array,
    'Array',
    function (e, t) {
      gi(this, { type: 'Array Iterator', target: P(e), index: 0, kind: t });
    },
    function () {
      var e = bi(this),
        t = e.target,
  ...
  var wi = y(function () {
    ...
    _i =
      y(function () {
        ...
        ? function (e) {
            return !!W(e) && (!wi || 'ArrayBuffer' != R(e)) && (!Si || Si(e));
          }
        : Si,
    ki = !y(function () {
    ...
    Ii = l(function (e) {
      var t = Pe.f,
        ...
        a = (e.exports = {
          ...
          onFreeze: function (e) {
            return ki && n && _i(e) && !fe(e, r) && i(e), e;
          },
        });
      Be[r] = !0;
    });
  Ii.enable, Ii.fastKey, Ii.getWeakData, Ii.onFreeze;
  var Ti = p.TypeError,
    Oi = function (e, t) {
    ...
    xi = function (e, t, n) {
      var r,
        ...
        p = Qn(t, l),
        y = function (e) {
          return r && ko(r, 'normal', e), new Oi(!0, e);
        },
        v = function (e) {
          return f
            ? (je(e), h ? p(e[0], e[1], y) : p(e[0], e[1]))
            : h
            ? p(e, y)
            : p(e);
        };
      if (d) r = e;
        ...
        if (!(o = Co(e))) throw Ti($(e) + ' is not iterable');
        if (Eo(o)) {
          for (i = 0, a = pt(e); a > i; i++)
            if ((c = v(e[i])) && N(Ei, c)) return c;
          return new Oi(!1);
        }
        r = Fo(e, o);
      }
      for (s = r.next; !(u = g(s, r)).done; ) {
        ...
        if ('object' == typeof c && c && N(Ei, c)) return c;
      }
      return new Oi(!1);
    },
    Ci = p.TypeError,
      ...
      getConstructor: function (e, t, n, r) {
        var o = e(function (e, o) {
            Ri(e, i),
              ...
              v || (e.size = 0),
              null != o && xi(o, e[r], { that: e, AS_ENTRIES: n });
          }),
          i = o.prototype,
          a = Pi(t),
          c = function (e, t, n) {
          ...
          Fi(i, {
            ...
            forEach: function (e) {
              for (
                var t,
                  n = a(this),
                  r = Qn(e, arguments.length > 1 ? arguments[1] : void 0);
                (t = t ? t.next : n.first);
  ...
  !(function (e, t, n) {
      ...
      l = function (e) {
        ...
        at(
          ...
          'add' == e
            ...
            : 'delete' == e
            ? function (e) {
                return !(o && !W(e)) && t(this, 0 === e ? 0 : e);
              }
            : 'get' == e
            ? function (e) {
                return o && !W(e) ? void 0 : t(this, 0 === e ? 0 : e);
              }
            : 'has' == e
            ? function (e) {
                return !(o && !W(e)) && t(this, 0 === e ? 0 : e);
    ...
    if (
      ...
      (s = n.getConstructor(t, e, r, i)), Ii.enable();
    else if (jt(e, !0)) {
      var f = new s(),
        d = f[i](o ? {} : -0, 1) != f,
        h = y(function () {
      ...
      v ||
        (((s = t(function (e, t) {
          ...
          return null != t && xi(t, n[i], { that: n, AS_ENTRIES: r }), n;
        })).prototype = c),
        (c.constructor = s)),
    ...
    Yn.Set;
  var Vi = setTimeout,
    Ni = 'undefined' != typeof setImmediate ? setImmediate : null;
  function Xi(e) {
        ...
        zi._immediateFn(function () {
          ...
          if (null !== n) {
            ...
            try {
              ...
              return void Bi(t.promise, e);
            }
            Ji(t.promise, r);
          } else (1 === e._state ? Ji : Bi)(t.promise, e._value);
        }))
      : e._deferreds.push(t);
  }
  function Ji(e, t) {
    try {
      ...
      if (t && ('object' == typeof t || 'function' == typeof t)) {
        var n = t.then;
        if (t instanceof zi) return (e._state = 3), (e._value = t), void Gi(e);
  ...
  function Bi(e, t) {
    (e._state = 2), (e._value = t), Gi(e);
  }
  function Gi(e) {
    2 === e._state &&
      0 === e._deferreds.length &&
      zi._immediateFn(function () {
        e._handled || zi._unhandledRejectionFn(e._value);
      });
    for (var t = 0, n = e._deferreds.length; t < n; t++) Yi(e, e._deferreds[t]);
    e._deferreds = null;
  }
  function Mi(e, t, n) {
  ...
  (zi.prototype.catch = function (e) {
    return this.then(null, e);
  }),
    (zi.prototype.then = function (e, t) {
      var n = new this.constructor(Di);
      return Yi(this, new Mi(e, t, n)), n;
    }),
    (zi.prototype.finally = Wi),
    (zi.all = function (e) {
      return new zi(function (t, n) {
        if (!Xi(e)) return n(new TypeError('Promise.all accepts an array'));
        var r = Array.prototype.slice.call(e);
        if (0 === r.length) return t([]);
        var o = r.length;
        function i(e, a) {
    ...
    (zi.allSettled = Zi),
    (zi.resolve = function (e) {
      return e && 'object' == typeof e && e.constructor === zi
        ? e
        : new zi(function (t) {
            t(e);
          });
    }),
    (zi.reject = function (e) {
      return new zi(function (t, n) {
        n(e);
      });
    }),
    (zi.race = function (e) {
      return new zi(function (t, n) {
        if (!Xi(e)) return n(new TypeError('Promise.race accepts an array'));
        for (var r = 0, o = e.length; r < o; r++) zi.resolve(e[r]).then(t, n);
      });
    }),
    (zi._immediateFn =
      ('function' == typeof Ni &&
    ...
    (zi._unhandledRejectionFn = function (e) {
  ...
  'function' != typeof qi.Promise
    ? (qi.Promise = zi)
    : (qi.Promise.prototype.finally || (qi.Promise.prototype.finally = Wi),
      qi.Promise.allSettled || (qi.Promise.allSettled = Zi)),
    (function (e) {
      function t() {}
      function n(e, t) {
        if (
  ...
  var $i = u(
                    ...
                    case 0:
                      return (
                        ...
                        null === (a = n.getItem(i))
                          ...
                          ? [3, 2]
                          : [4, Qi.default().lock(a.iat)]
                      );
                    case 1:
                      r.sent(),
                        this.acquiredIatSet.delete(a.iat),
                        n.removeItem(i),
                        Qi.default().unlock(a.iat),
                        e.notifyWaiters(),
                        (r.label = 2);
                    case 2:
                      return [2];
    ...
    na = { name: 'auth0-spa-js', version: '1.19.3' },
    ra = function () {
      return Date.now();
    },
    oa = (function (e) {
        ...
        (r = function (a) {
          if (a.data && 'authorization_response' === a.data.type) {
            if (
              ...
              return n(oa.fromPayload(a.data.response));
            t(a.data.response);
          }
        }),
    ...
    ha = function () {
      var e =
        ...
        t = '';
      return (
        Array.from(fa().getRandomValues(new Uint8Array(43))).forEach(function (
          n,
        ) {
  ...
  var ba = function (e, t) {
    ...
    _a = function (e, t, n, r, a, c, s) {
      return (
        void 0 === s && (s = 1e4),
        o(void 0, void 0, void 0, function () {
          return i(this, function (o) {
            return a ? [2, Sa(e, t, n, r, s, a, c)] : [2, wa(e, r, s)];
          });
        })
      );
    };
  function ka(e, t, n, a, c, s, u) {
      ...
      return i(this, function (i) {
        switch (i.label) {
          ...
          case 1:
            ...
            i.label = 2;
          case 2:
            return i.trys.push([2, 4, , 5]), [4, _a(e, n, a, c, s, u, t)];
          case 3:
          ...
          case 6:
            ...
            if (
              ...
              throw new oa(p || 'request_error', m);
            }
            return [2, v];
        }
      });
                  ...
                  s,
                  {
                    ...
                    headers: {
                      'Content-Type': l
                        ...
                        : 'application/json',
                      'Auth0-Client': btoa(JSON.stringify(u || na)),
                    },
                  },
                  t,
                  l,
  ...
  var Ta = function (e) {
    ...
    Oa = function () {
      ...
      return Ta(e.join(' ').trim().split(/\s+/)).join(' ');
    },
    Ea = (function () {
      function e(e, t) {
    ...
    Ua = function (e) {
      ...
      var t = (function (e) {
        ...
        var c = JSON.parse(ma(o)),
          s = { __raw: e },
          u = {};
        return (
          Object.keys(c).forEach(function (e) {
            (s[e] = c[e]), ja.includes(e) || (u[e] = c[e]);
          }),
          {
      ...
      if (e.max_age && !Aa(t.claims.auth_time))
        throw new Error(
    ...
    Va = {
      ...
      save: function (e, t, n) {
        ...
        'https:' === window.location.protocol && (r = { secure: !0 }),
          (null == n ? void 0 : n.daysUntilExpire) &&
            (r.expires = n.daysUntilExpire),
          La('_legacy_' + e, JSON.stringify(t), r),
          Za.save(e, t, n);
      },
      remove: function (e) {
        Za.remove(e), Za.remove('_legacy_' + e);
      },
    },
    Na = {
      get: function (e) {
  ...
  var Da,
    ...
    Ba =
      ...
      (Ya = !1),
      function (e) {
        return (Ja = Ja || Xa(Da, za, Ya)), new Worker(Ja, e);
      }),
    Ga = {},
    Ma = (function () {
      function e(e, t) {
      ...
      function e(e) {
        ...
        if (
          ...
          if (
            ...
            !Qa(this.cacheLocation))
          )
            throw new Error(
              'Invalid cache location "' + this.cacheLocation + '"',
            );
          o = Qa(this.cacheLocation)();
        }
        (this.cookieStorage = !1 === e.legacySameSiteCookie ? Za : Va),
        ...
        var i,
          a = e.useCookiesForTransactions ? this.cookieStorage : Na;
        (this.scope = this.options.scope),
          (this.transactionManager = new Fa(a, this.options.client_id)),
          (this.nowProvider = this.options.nowProvider || ra),
          (this.cacheManager = new Ra(
            o,
            o.allKeys ? null : new Ma(o, this.options.client_id),
            this.nowProvider,
          )),
          (this.domainUrl =
          ...
          this.options.useRefreshTokens &&
            (this.scope = Oa(this.scope, 'offline_access')),
          'undefined' != typeof window &&
            window.Worker &&
            this.options.useRefreshTokens &&
      ...
      return (
        (e.prototype._url = function (e) {
          var t = encodeURIComponent(
            btoa(JSON.stringify(this.options.auth0Client || na)),
          );
        ...
        (e.prototype._getParams = function (e, t, o, i, a) {
          ...
          return n(n(n({}, s), e), {
            scope: Oa(this.defaultScope, this.scope, e.scope),
            response_type: 'code',
            response_mode: 'query',
            state: t,
            nonce: o,
        ...
        (e.prototype._authorizeUrl = function (e) {
          return this._url('/authorize?' + ya(e));
        }),
                ...
                switch (o.label) {
                  case 0:
                    return (
                      ...
                      (n = Oa(this.defaultScope, this.scope, e.scope)),
                      [
                        4,
            ...
            o(this, void 0, void 0, function () {
              ...
              return i(this, function (p) {
                switch (p.label) {
                  ...
                  case 12:
                    return [4, Ha.releaseLock('auth0.lock.getTokenSilently')];
                  case 13:
                    return p.sent(), [7];
                  case 14:
                    return [3, 16];
                ...
                switch (r.label) {
                  case 0:
                    return (
                      ...
                      (e.scope = Oa(this.defaultScope, this.scope, e.scope)),
                      (t = n(n({}, ea), t)),
        ...
        (e.prototype.buildLogoutUrl = function (e) {
          ...
          var t = e.federated,
            n = r(e, ['federated']),
            o = t ? '&federated' : '';
          return this._url('/v2/logout?' + ya(n)) + o;
        }),
        ...
        (e.prototype._getTokenFromIFrame = function (e) {
          return o(this, void 0, void 0, function () {
            ...
            return i(this, function (i) {
              switch (i.label) {
                case 0:
                  return (t = pa(ha())), (o = pa(ha())), (a = ha()), [4, va(a)];
                case 1:
                  (c = i.sent()),
                    (s = ga(c)),
                        ...
                        if (
                          ...
                          a && a.close(),
                            n.data.response.error
                              ? t(oa.fromPayload(n.data.response))
                              : e(n.data.response),
                            clearTimeout(i),
                            window.removeEventListener('message', r, !1),
                            setTimeout(o, 2e3);
                ...
                case 4:
                  return (
                    (g = i.sent()), [4, this._verifyIdToken(g.id_token, o)]
                  );
                case 5:
                  return (
                    (b = i.sent()),
              ...
              switch (i.label) {
                case 0:
                  return [
                    4,
                    this.cacheManager.get(
                      new Ea({ scope: t, audience: r, client_id: a }),
                      60,
                    ),
                  ];
                case 1:
  ...
  function nc(e) {
    return o(this, void 0, void 0, function () {
      ...
      return i(this, function (n) {
        switch (n.label) {
          case 0:
            return [4, (t = new ec(e)).checkSession()];
          case 1:
            return n.sent(), [2, t];
        }
      });
